...
public class SearchResultsActivity extends AppCompatActivity {
    ...
    Utils utils = new Utils(SearchResultsActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPref = PreferenceManager.getDefaultSharedPreferences(SearchResultsActivity.this);
        bookList = new ArrayList<>();
        adapter = new BooksAdapter(SearchResultsActivity.this, bookList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(SearchResultsActivity.this, 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new GridSpacingItemDecoration(1, dpToPx(2), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);

        query = getIntent().getStringExtra(Constants.TAG_BOOK_SEARCH_QUERY);
    ...
    class getAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            Log.d("RESPONSE: ", query);
            params.add(new BasicNameValuePair(Constants.TAG_BOOK_SEARCH_QUERY, query));
            JSONObject json = jParser.makeHttpRequest(Constants.TAG_SERVER_MAIN_URL+Constants.TAG_SERVER_SEARCH_BOOK, "GET", params);
